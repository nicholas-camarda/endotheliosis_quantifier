...
- [ ] 1.1 Inventory what source provenance exists, if any, from the admitted `raw_data/cohorts` manifest rows and Lauren's direct `raw_data/cohorts/lauren_preeclampsia` paired root back to larger MR/TIFF source images.
