...
Define the deterministic audit workflow that distinguishes threshold-policy artifacts from true glomeruli segmentation overcoverage, records probability-level evidence, and gates later full retraining decisions.
