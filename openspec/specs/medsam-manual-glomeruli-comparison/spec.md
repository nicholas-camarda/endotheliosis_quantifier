## Purpose
Define the completed MedSAM oracle-box glomeruli comparison workflow, including deterministic admitted manual-mask input selection, isolated generated artifacts, tiled current-segmenter baselines, and audit-scoped interpretation.
