...
class TestQualityAssessor(unittest.TestCase):
    ...
    def test_assess_segmentation_quality(self):
        ...
        self.assertAlmostEqual(metrics.dice_coefficient, 1.0, places=6)  # Allow for floating point precision
        self.assertAlmostEqual(metrics.iou_score, 1.0, places=6)
...
class TestReportingSystemIntegration(unittest.TestCase):
    ...
    def test_complete_reporting_workflow(self):
        ...
        self.assertIn("Segmentation Training", summary)  # Check for formatted stage name
        self.assertIn("✅", summary)  # Completion emoji
        self.assertIn("data_loading", summary)  # Error category mentioned
