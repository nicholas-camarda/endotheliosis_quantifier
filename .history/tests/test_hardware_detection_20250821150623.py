...
class TestHardwareDetector:
    ...
    def test_detect_capabilities_cuda(self, mock_machine, mock_system, mock_memory,
                                    mock_properties, mock_device_name, mock_cuda_count,
                                    mock_cuda_available, mock_mps_built, mock_mps_available):
        ...
        # Mock GPU properties
        mock_properties.return_value.total_memory = 10 * 1024**3  # 10 GB
