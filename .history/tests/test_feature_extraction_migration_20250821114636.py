...
def test_feature_extractor_helper_functions():
    ...
    from feature_extractor_helper_functions import (load_pickled_data,
...
def test_quantify_endotheliosis():
    ...
    spec = importlib.util.spec_from_file_location("quantify_endotheliosis", "scripts/main/4_quantify_endotheliosis.py")
    quantify_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(quantify_module)
    
    run_random_forest = quantify_module.run_random_forest
    load_pickled_data = quantify_module.load_pickled_data
