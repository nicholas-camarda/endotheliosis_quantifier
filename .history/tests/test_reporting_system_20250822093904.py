...
class TestQualityAssessor(unittest.TestCase):
    ...
    def test_assess_segmentation_quality(self):
        ...
        self.assertAlmostEqual(metrics.dice_coefficient, 1.0, places=10)  # Allow for floating point precision
        self.assertAlmostEqual(metrics.iou_score, 1.0, places=10)
