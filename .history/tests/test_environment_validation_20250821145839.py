...
from eq.utils.env_check import verify_environment_name, read_environment_name_from_yaml
...
class TestEnvironmentValidation:
    ...
    def test_environment_file_missing_name_field(self):
        ...
        with patch('pathlib.Path.exists', return_value=True), \
             patch('builtins.open', return_value=MagicMock(__enter__=MagicMock(return_value=mock_content.splitlines()), __exit__=MagicMock())):
