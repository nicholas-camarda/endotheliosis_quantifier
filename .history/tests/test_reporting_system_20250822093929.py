...
class TestPipelineTracker(unittest.TestCase):
    ...
    def test_generate_progression_report(self):
        ...
        self.assertIn("Segmentation Training", report)  # Check for formatted stage name
...
class TestStageReporter(unittest.TestCase):
    ...
    def test_generate_quantification_report(self):
        ...
        self.assertIn("98.00%", report)  # Success rate (formatted as percentage)
...
class TestPerformanceMonitor(unittest.TestCase):
    ...
    def test_get_performance_summary(self):
        ...
        # Check that we have metrics (may be empty if psutil fails in test environment)
        if 'error' not in summary:
            ...
            # If psutil fails in test environment, just verify the error structure
...
class TestQualityAssessor(unittest.TestCase):
    ...
    def test_assess_segmentation_quality(self):
        ...
        self.assertAlmostEqual(metrics.dice_coefficient, 1.0, places=8)  # Allow for floating point precision
        self.assertAlmostEqual(metrics.iou_score, 1.0, places=8)
        self.assertAlmostEqual(metrics.precision, 1.0, places=8)
        self.assertAlmostEqual(metrics.recall, 1.0, places=8)
        self.assertAlmostEqual(metrics.f1_score, 1.0, places=8)
...
class TestExecutiveSummaryGenerator(unittest.TestCase):
    ...
    def test_generate_executive_summary(self):
        ...
        self.assertIn("Segmentation Training", summary)  # Check for formatted stage name
    ...
    def test_generate_quick_summary(self):
        ...
        self.assertIn("33.3%", summary)  # Completion percentage (1/3 stages)
        self.assertIn("✅", summary)  # Completion emoji
    ...
    def test_create_dashboard_summary(self):
        ...
        self.assertEqual(dashboard_data['completion_rate'], 33.33333333333333)  # 1/3 stages completed
        self.assertEqual(dashboard_data['success_rate'], 100.0)  # 1 completed, 0 failed
