...
def pipeline_orchestrator_command(args):
    ...
    if choice == "1":
        ...
        from eq.pipeline.run_production_pipeline import run_quick_test
        run_quick_test()
        ...
        from eq.visualization.create_better_visualization import create_enhanced_visualization
        ...
        print("  # Quick test")
        print("  python -m eq pipeline --quick-test")
        print()
        print("  # Full production")
        print("  python -m eq pipeline")
        print()
        print("  # Visualization")
        print("  python -m eq visualization")
        print()
        print("  # Smoke test")
