...
def train_segmentation_model(base_model_path, cache_dir, output_dir, model_name='glomerulus_segmenter', batch_size=8, epochs=50):
    """Wrapper function for training segmentation model with CLI arguments."""
    # Set up paths
    ...
    file_name_with_ext = f"{file_name}.h5"
