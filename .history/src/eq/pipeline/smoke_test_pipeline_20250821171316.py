...
import cv2
import numpy as np
from fastai.vision.all import resnet50, get_image_files
import torch
...
def main() -> None:
    data_root = Path("data/preeclampsia_data")
