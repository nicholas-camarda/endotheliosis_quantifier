...
# SM backbones use 3 channel images, so let us read images in color.
...
mask_dataset_reshaped_encoded = labelencoder.fit_transform(
    mask_dataset_reshaped)
...
# because we are dealing with 4 class problem here
focal_loss = sm.losses.CategoricalFocalLoss()
# you can add more or less weight to focal loss by changging the 1
