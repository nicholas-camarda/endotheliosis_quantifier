...
y_train = load_pickled_data(os.path.join(regression_cache_dir_path, 'y_train_regression.pkl'))
...
y_val = load_pickled_data(os.path.join(regression_cache_dir_path, 'y_val_regression.pkl'))
