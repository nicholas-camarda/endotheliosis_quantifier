...
- [ONBOARDING_GUIDE.md](ONBOARDING_GUIDE.md)
  Beginner-friendly introduction to the project, datasets, segmentation workflow, and the current scored-cohort quantification path.
...
- [archive/fastai_legacy_integration.md](archive/fastai_legacy_integration.md)
  Reference-only notes for an older FastAI glomeruli integration path.

- [archive/fastai_pipeline_integration_plan.md](archive/fastai_pipeline_integration_plan.md)
  Reference-only planning notes for an older glomeruli integration path.

- [archive/fastai_historical_implementation_analysis.md](archive/fastai_historical_implementation_analysis.md)
  Reference-only historical implementation analysis for older FastAI artifact behavior.
